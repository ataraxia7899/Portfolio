    ...
    <section id="hero" className="hero">
      <div className="hero-content">
        ...
        <h1 className="hero-title">
          저는 <span className="hero-title-gradient">{profile.name}</span>입니다
        </h1>
        ...
        <div className="hero-cta">
          ...
          <a href={profile.github} target="_blank" rel="noopener noreferrer" className="hero-btn hero-btn-secondary">
